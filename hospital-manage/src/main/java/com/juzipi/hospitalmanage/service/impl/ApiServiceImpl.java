package com.juzipi.hospitalmanage.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.juzipi.hospitalmanage.mapper.HospitalSetMapper;
import com.juzipi.hospitalmanage.mapper.ScheduleMapper;
import com.juzipi.hospitalmanage.model.HospitalSet;
import com.juzipi.hospitalmanage.model.Schedule;
import com.juzipi.hospitalmanage.service.ApiService;
import com.juzipi.hospitalmanage.util.BeanUtils;
import com.juzipi.hospitalmanage.util.HttpRequestHelper;
import com.juzipi.hospitalmanage.util.MD5;
import com.juzipi.hospitalmanage.util.YyghException;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        ...
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("hpCode",this.getHpCode());
        paramMap.put("hpName",jsonObject.getString("hpName"));
        paramMap.put("hpType",jsonObject.getString("hpType"));
        ...
        paramMap.put("introduction",jsonObject.getString("introduction"));
    ...
    public boolean saveSchedule(String data) {
        ...
        for(int i=0, len=jsonArray.size(); i<len; i++) {
            ...
            Map<String, Object> paramMap = new HashMap<>();
            paramMap.put("hpCode",schedule.getHpCode());
    ...
    public void  saveBatchHospital() throws IOException {
        ...
        for(int i=1, len=jsonArray.size(); i<len; i++) {
            ...
            Map<String, Object> paramMap = new HashMap<>();
            paramMap.put("hpCode","1000_"+i);
            paramMap.put("hosName",jsonObject.getString("hosName"));
            paramMap.put("hpType",i % 3 == 0 ? 1 : i % 3 == 1 ? 2 :4);
            ...
            String introduction = "北京协和医院是集医疗、教学、科研于一体的大型三级甲等综合医院，是国家卫生计生委指定的全国疑难重症诊治指导中心，也是最早承担高干保健和外宾医疗任务的医院之一，以学科齐全、技术力量雄厚、特色专科突出、多学科综合优势强大享誉海内外。在2010、2011、2012、2013、2014年复旦大学医院管理研究所公布的“中国最佳医院排行榜”中连续五年名列榜首。\n" +
                    "\n" +
